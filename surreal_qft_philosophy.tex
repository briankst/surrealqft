...
\begin{center}
\begin{tabular}{>{\raggedright\arraybackslash}p{3cm}@{\hspace{4pt}}c@{\hspace{4pt}}c@{\hspace{4pt}}c@{\hspace{4pt}}c}
\hline
\textbf{Approach} & \textbf{Det.} & \textbf{Local} & \textbf{QM} & \textbf{GR} \\
\hline
...
Super\-deterministic & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\times$ \\
...
\subsection{Ontology of \texorpdfstring{$\epsilon_i$}{εi}-Tags}
...
\bibitem{LIGO2016} Abbott, B. P., et al. (LIGO Scientific Collaboration and Virgo Collaboration). (2016). 
Observation of Gravitational Waves from a Binary Black Hole Merger. \emph{Physical Review Letters}, 
116(6), 061102. \href{https://doi.org/10.1103/PhysRevLett.116.061102}{DOI: 10.1103/PhysRevLett.116.061102}
...
\bibitem{Hossenfelder2020} Hossenfelder, S. (2020). Rethinking\\ 
superdeterminism. \emph{Frontiers in Physics}, 8, 139.\\
DOI: \href{https://doi.org/10.3389/fphy.2020.00139}{10.3389/fphy.2020.00139}
